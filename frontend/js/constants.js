...
const welcome_h1 = "Welcome to the Amazon $Frogz NFT Collection!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Amazon $Frogz NFT Collection is the first series of a brazilian-based & climate-positive project that aims to preserve the Amazon Rainforest through a conservation fund with traditional partners';
